...
export class FirebaseWebService extends FirebaseService implements OnDestroy{
  ...
  async init(){
    const firebaseConfig = {
      apiKey: "AIzaSyCbET5y_Y-wee0nIcX7Mkk9DN_4-x5PBpk",
      authDomain: "tradingfy-ionic.firebaseapp.com",
      projectId: "tradingfy-ionic",
      storageBucket: "tradingfy-ionic.appspot.com",
      messagingSenderId: "157375087643",
      appId: "1:157375087643:web:89ea837f43456bb37f24be",
      measurementId: "G-JSS0LWP173"
    };
